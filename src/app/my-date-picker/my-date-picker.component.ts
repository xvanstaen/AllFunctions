...
SelectedDay?:DaysOfMonths;
  ...
  onSelectCalendOne(array_month:DaysOfMonths){
    ...
    this.initObj=selectDay(1, this.SelectedDay, this.datePipe, this.ref_format.MyDateFormat,this.locale,this.initObj, this.datePipeMax, this.datePipeToday);
  ...
  onSelectCalendTwo(array_month:DaysOfMonths){
    ...
    this.error_msg='';
    this.SelectedDay=array_month;
    this.initObj=selectDay(2, this.SelectedDay, this.datePipe, this.ref_format.MyDateFormat,this.locale,this.initObj,this.datePipeMax, this.datePipeToday);
    this.type_error=this.initObj.type_error;
    this.error_msg=this.initObj.error_msg;
